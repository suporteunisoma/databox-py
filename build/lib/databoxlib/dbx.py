...
def dbx_call_service(access_token, entity_catalog):
    ...
    url = f"http://192.168.7.221:9091/databox/api/dbxmetadata/findMetaDataByCatalogName/{entity_catalog}"
...
# access_token = dbx_authenticate()
# sql = dbx_call_service(access_token, 'bi_sonar_project')
# print(load_data('bi_sonar_project'))
